...
import net.sf.sockettest.module.SocketClient;
import net.sf.sockettest.ssl.MyTrustManager;
...
public class SocketTestClient extends JPanel {
    ...
    private void connect() {
        ...
        changeBorder(" " + socket.getInetAddress()
                                 .getHostName()
    ...
    public void append(String msg) {
        ...
        messagesField.setCaretPosition(messagesField.getText()
                                                    .length());
    }
